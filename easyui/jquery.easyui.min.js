...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        ...
        displayMsg: "本页从 {from} 到 {to} 总共 {total} 条记录",
        nav: {
            first: {
...
(function ($) {
    ...
    function _158(_159, _15a) {
        ...
        /*更改添加 attributes 属性*/
        if( _15a.hasOwnProperty('attributes') ){
            _15a.data[0].attributes = _15a.attributes;
        }
        var data = _15a.data;
    ...
    function _162(_163, _164) {
        ...
        if (_165) {
            if (!_165.children || !_165.children.length) {
                ...
                /*更改 让没有文件的文件件不消失文件夹的图标*/
                // node.find(".tree-icon").removeClass("tree-folder").addClass("tree-file");
                node.find(".tree-icon").removeClass("tree-folder-open");
    ...
    function _12c(_168, _169) {
        ...
        $.extend(data, _169);
        var _formatStr = opts.formatter.call(_168, data);
        node.find(".tree-title").html(_formatStr);
        if (data.iconCls) {
    ...
    var _1c0 = {
        render: function (_1c1, ul, data) {
            ...
            $(ul).append(cc.join(""));
            function _1c6(_1c7, _1c8) {/*信息封装在 _1c8 里面*/
                var cc = [];
...
(function ($) {
    ...
    function _429(e) {
        ...
        if (item.length) {
            ...
            /*更改取消按钮禁用，不可点击的事件*/
            // console.log(item.data("menuitem"));
            /*更改*/
            if( item.data("menuitem") == undefined ){
                return;
            }
...
(function ($) {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        }, currentText: "今天", closeText: "关闭", okText: "确认", buttons: [{
            text: function (_b45) {
